...
| --- | --- | --- |
| `deno run --allow-read scripts/validate-qa.ts --fixture _meta/validator-fixtures/qa/invalid/verification-missing-test-plan-reference.md` | FAIL | Missing test-plan reference must be rejected. |
