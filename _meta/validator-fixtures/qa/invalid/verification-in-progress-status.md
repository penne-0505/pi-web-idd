...
| --- | --- | --- |
| `deno run --allow-read scripts/validate-qa.ts --fixture _meta/validator-fixtures/qa/invalid/verification-in-progress-status.md` | FAIL | Completed verification cannot remain in progress. |
