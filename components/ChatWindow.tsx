...
export function ChatWindow({ session, sessionRunning, newSessionCwd, newSessionDraftKey, onAgentEnd, onAttentionNeeded, onSessionCreated, onSessionForked, modelsRefreshKey, chatInputRef, onBranchDataChange, onSystemPromptChange, onSystemPromptLoaderChange, onSessionStatsChange, onSessionStatsPanelOpen, onContextUsageChange, onOpenFile, soundEnabled = true, onSoundToggle, playDoneSound = () => {}, unlockAudio }: Props) {
  ...
  return (
    ...
    >
      {isDragOver && (
        <div className="pointer-events-none absolute inset-0 z-50 flex animate-[drop-zone-in_0.15s_ease_both] items-center justify-center bg-[rgba(128,128,128,0.08)] backdrop-blur-[1px]">
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            {[0, 0.8, 1.6].map((delay) => (
              <div
                key={delay}
                className="absolute h-[720px] w-[720px] rounded-full border-[1.5px] border-solid border-[rgba(128,128,128,0.55)] animate-[drop-ripple_2.4s_ease-out_infinite_backwards]"
          ...
          <svg
            ...
            className="drop-shadow-[0_6px_18px_rgba(0,0,0,0.16)]"
          >
            <rect x="28" y="44" width="84" height="60" rx="8" fill="rgba(128,128,128,0.10)" stroke="rgba(128,128,128,0.55)" strokeWidth="1.8"/>
            <path d="M36 100 L54 72 L68 88 L80 74 L104 100Z" fill="rgba(128,128,128,0.18)" stroke="rgba(128,128,128,0.45)" strokeWidth="1.4" strokeLinejoin="round"/>
            <circle cx="96" cy="58" r="8" fill="rgba(128,128,128,0.24)" stroke="rgba(128,128,128,0.60)" strokeWidth="1.6"/>
            <g stroke="rgba(128,128,128,0.50)" strokeWidth="1.4" strokeLinecap="round">
        ...
        return (
          <div
            ...
            style={{
              ...
              boxShadow: floating
                ? "0 1px 2px rgba(0,0,0,0.06), 0 10px 28px -14px rgba(0,0,0,0.22)"
                : "0 1px 2px rgba(0,0,0,0.05), 0 8px 24px -12px rgba(0,0,0,0.10)",
              fontSize: 18,
              lineHeight: 1.45,
